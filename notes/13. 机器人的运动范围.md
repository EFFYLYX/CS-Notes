...
class Solution:
    ...
    def movingCount(self, m: int, n: int, k: int) -> int:
        ...
        def backtrack(x,y,k, visit):
            if x <0 or y <0 or x >= m or y >= n or visit[x][y] or digitSum(x) + digitSum(y) >k:
                return
            ...
            backtrack(x-1,y,k,visit)
            backtrack(x+1, y, k, visit)
            backtrack(x,y-1,k,visit)
            backtrack(x, y+1,k, visit)

           
            backtrack(0, 0, k, visit)
           # #visit[x][y] = False
